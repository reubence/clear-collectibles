...
function Shop() {
  return (
    <div className="">
      ...
      <div className="bg-[#E7F1F5] bottom-0 absolute w-full">
        ...
        <div className="p-5 bg">
          <Button className="lg:hidden gap-0.5 text-base font-bold text-white uppercase py-3 h-fit w-full rounded-2xl">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
